...
class Cli:
        ...
        if self.path == '/crawl':
            ...
            if len(params) == 0:
                ...
                for watch_id in params:
                    ...
                    try:
                        source_path = '/mnt/'
                        # source_path = '/Volumes/workspace/etc/cr-k8s-vagrant/projects/cr-py-crawler/youtube'
    ...
    def run_craler(self, watch_ids='', exec_type='GET'):
        ...
        out = ''
        if exec_type == 'POST':
            # curl -d "watch_ids=ioNng23DkIM" -X POST http://192.168.1.10:8000/crawl
            ...
            # curl http://192.168.1.10:8000/crawl?watch_ids=ioNng23DkIM
            # curl http://cr-py-crawler:8000/crawl?watch_ids=
            process = subprocess.Popen(
...
def run(type="POST", domain="http://cr-py-crawler:8000", path="/crawl", list="/mnt/list.txt", query="", json_path="/mnt/result"):
...
# python youtube/youtube/cli.py -l /Volumes/workspace/etc/cr-k8s-vagrant/projects/cr-py-crawler/youtube/list.txt
# python3 youtube/youtube/cli.py -l /mnt/list.txt -d http://192.168.1.10:30007 -j /mnt/test
# python youtube/youtube/cli.py -t GET -q watch_ids=kVQEW0SNFqE
# python3 youtube/cli.py -l /mnt/list.txt -d http://192.168.1.10:30007 -j /mnt/result
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--domain",
        default='http://cr-py-crawler:8000',
